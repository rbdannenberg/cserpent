...
int64_t find(Any s, StringPtr pattern, int64_t start=0, int64_t end=std::numeric_limits<int64_t>::max());
int64_t find(Any s, Any pattern,  Any start=0, int64_t end=std::numeric_limits<int64_t>::max());
int64_t find(StringPtr s, Any pattern, int64_t start=0, int64_t end=std::numeric_limits<int64_t>::max());
Any subseq(Any s, Any start, Any end = std::numeric_limits<int64_t>::max());
